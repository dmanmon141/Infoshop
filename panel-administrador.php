...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="estilo-panel-administrador.css">
...
<h3>Todas las categorías</h3>
  ...
  <!-- Resto del contenido de la página -->
        <div class="dividir">
            ...
            <div class="bloque1">
                <a  href="panel-administrador?productos"><div class="seccionproductos">Productos</div></a>
                <a href="panel-administrador?tickets"><div class="secciontickets">Tickets</div></a>
                <a href="panel-administrador?notificaciones"><div class="seccionnotificaciones">Notificaciones</div></a>
                <a href="panel-administrador?basedatos"><div class="seccionbasedatos">Base de datos</div></a>
            </div class="bloque1">
    ...
    <!-- Contenido de la pagina -->
                       ...
                       <div id="popup1" class="popup">
                        ...
                        <div class="acciones">
                          ...
                          if(!empty($productoarray)){
                           ...
                           <input type="text" name="prodcod2" id="prodcod2" style="display: none" value="<?php echo $productoarray['PRODCOD'] ?>">
                           </div>
                           <div class="fila">
          ...
          if(mysqli_num_rows($ticketsquery) != 0){
                        ...
                        <div class="notificacion">
                          <input type="text" style="display:none" id="notcod-input<?php echo $notificacionesarray['ADMCOD'] ?>" name="notcod" value="<?php echo $notificacionesarray['ADMCOD'] ?>">
