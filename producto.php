...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="estilo-producto.css">
  ...
  <div class="popup-contenido">
    ...
    <div class="product">
      ...
      <div class="product-details">
        ...
        <p class="product-offer"><?php echo "- " . $oferta . "% dto." ?></p>
        <p class="product-stock"> <?php if($stock == 1){echo "✅ En stock" . " (" . $inventario . ")";}else{echo "Fuera de stock";} ?> </p>
        </div>
        <div class="separar">
        <div class="bloque1">
        ...
        <button class="product-btn" onclick="addToCart('<?php echo $titulo ?>', '<?php echo $imagen ?>', '<?php echo $precio . '€' ?>')">Añadir al carrito</button>
        </div>
        <br>
      </div>
    </div>
    ...
    <div class="popup-botones">
      ...
      while($array3 = mysqli_fetch_row($comentariocheckresultado)){
        ...
        <div class="reseña">
            ...
            <div class="reportar"><img src="img/report.png"><a onclick="mostrarPopup3()" id="reportar">Reportar</a></div>
          </div>
