...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="estilo-datospago.css">
...
<h3>Todas las categorías</h3>
  ...
  <!-- Resto del contenido de la página -->
        ...
        <div class="dividir">
            ...
            <div class="bloque1">
                <a  href="perfil"><div class="secciondatos">Perfil</div></a>
                <a href="configuracion"><div class="seccionconfiguracion">Datos de pago</div></a>
                <a href="historial"><div class="seccionhistorial">Historial</div></a>
            </div class="bloque1">
                    ...
                    <div class="datosguardados">
                              ...
                              while($arraydatos = mysqli_fetch_row($datosguardadosresultado)){
                                ...
                                $ultimosDos = substr($arraydatos[3], -2);
                                  ...
                                  <h4><?php echo $i . " ." ?> <?php echo "Tarjeta " . $tarjeta ?></h4>
                                    <div class="dato">
                                                    ...
                                                    <h4>1. Método de pago</h4>
                                                      <form class="pago">
                                                        ...
                                                        <div class="organizar">
                                                        <input type="text" maxlength="14" class="disabled" minlength="14" id="tarjeta-input<?php echo $i ?>" value="************" readonly></input>
                                                        <input type="text" maxlength="5" class="disabled" id="caducidad-input<?php echo $i ?>" value="<?php echo $arraydatos[4] ?>" readonly></input>
                                                        <input type="number" maxlength="3" class="disabled" id="codigoseg-input<?php echo $i ?>" value ="<?php echo $arraydatos[5] ?>" readonly></input>
                                                        </div>
                                                      </form>
                                                    <h4>2. Dirección</h4>
                                                        <form class="direccion">
                                                            ...
                                                            <div class="tarjetahidden" id="tarjeta-hidden<?php echo $i ?>" style="display: none" data-value="<?php echo $arraydatos[3] ?>"></div>
                                                            <div class="organizar">
                                                            <input type="text" class="disabled" id="nombre-input<?php echo $i ?>" data-original-value="<?php echo $arraydatos[1] ?>" value="<?php echo $arraydatos[1] ?>" readonly></input>
                                                            <input type="text" class="disabled" id="apellidos-input<?php echo $i ?>" data-original-value="<?php echo $arraydatos[2] ?>" value="<?php echo $arraydatos[2] ?>" readonly></input>
                                                            <input type="text" class="disabled" id="ciudad-input<?php echo $i ?>" data-original-value="<?php echo $arraydatos[6] ?>" value="<?php echo $arraydatos[6] ?>" readonly></input>
                                                            </div>
                                                            <div class="organizar">
                                                            <p>Dirección</p>
                                                            <p>Código Postal</p>
                                                            ...
                                                            <div class="organizar">
                                                            <input type="text" class="disabled" id="direccion-input<?php echo $i ?>" data-original-value="<?php echo $arraydatos[7] ?>" value="<?php echo $arraydatos[7] ?>" readonly></input>
                                                            <input type="number" class="disabled" maxlength="5" id="codigopost-input<?php echo $i ?>" data-original-value="<?php echo $arraydatos[8] ?>" value="<?php echo $arraydatos[8] ?>" readonly></input>
                                                            </div>
                                                            <div class="organizar">
                                                            <p>País</p>
                                                            <p>Teléfono</p>
                                                            ...
                                                            <div class="organizar">
                                                                <input type="text" class="disabled" id="pais-input<?php echo $i ?>" data-original-value="<?php echo $arraydatos[9] ?>" value="<?php echo $arraydatos[9] ?>" readonly></input>
                                                                <input type="number" class="disabled" id="telefono-input<?php echo $i ?>" data-original-value="<?php echo $arraydatos[10] ?>" value="<?php echo $arraydatos[10] ?>" readonly></input>
                                                            </div>
                                                            <button id="aplicarcambios<?php echo $i ?>" class="botonfinal" onclick ="cambiarDatos(<?php echo $i ?>)" style="display: none">Aplicar cambios</button>
                                                            <br><br>
                                                            <div clas="organizar">
                                                                <button id="editar<?php echo $i ?>" onclick ="permitirEditar(<?php echo $i ?>)" class="botonfinal">Editar</button>
                                                                <button id="eliminar<?php echo $i?>" onclick ="mostrarPopup(<?php echo $i ?>)" class="botonfinal">Eliminar</button>
                                                            </div>
                                                            <div id="mensaje"></div>
                                                        </form>
                                                    </div>
