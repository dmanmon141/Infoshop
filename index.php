...
$productos2 = "SELECT PRODCOD, PRODNOM, PRODIMG, PRODPREC, PRODINV, PRODVAL, PRODPRECORI FROM productos WHERE PRODINV <= 12 AND PRODINV > 0 ORDER BY PRODINV ASC LIMIT 12;";
