  ...
  <div class="product">
      <div class="contenedor-imagen" onclick="redireccionar('<?php echo $array3[0] ?>')">
        ...
        <div class="texto-fondo">
          ...
          <p id="product-price"><?php echo $array3[3] . " €"?></p>
        </div>
      </div>
      </div>
...
<div class="anuncios">
    <div class="anuncio1"><img src="img/anuncio.png"></div>
    <div class="anuncio2"><img src="img/anuncio.png"></div>
</div>
  ...
  <div class="product">
      <div class="contenedor-imagen" onclick="redireccionar('<?php echo $array2[0] ?>')">
        ...
        <div class="texto-fondo">
          ...
          <p id="product-price"><?php echo $array2[3] . " €"?></p>
        </div>
      </div>
      </div>
  ...
  <div class="product">
      <div class="contenedor-imagen" onclick="redireccionar('<?php echo $array1[0] ?>')">
        ...
        <div class="texto-fondo">
          ...
          <p id="product-price"><?php echo $array1[3] . " €"?></p>
        </div>
      </div>
      </div>
