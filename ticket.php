...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="estilo-ticket.css">
...
if($ticketestado != "Abierto"){
        ?>
          <h3 style="color: white;text-align: center">Este ticket ha sido marcado como cerrado por un administrador del sistema.</h3>
        <?php
