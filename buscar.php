...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="estilo-buscar.css">
...
<h3>Todas las categorías</h3>
      ...
      <li class="busqueda">
        ...
        <form method="GET" action="" class="busqueda-formulario" onsubmit="aplicarFiltro()">
  ...
  <!-- Resto del contenido de la página -->
        ...
        <div class="dividir">
            ...
            ?>
              <label>
              <input type="checkbox" name="filtrocategoria" id="checkbox-left" onchange="aplicarFiltro()" value="<?php echo $arraycat2[0] ?>">
          ...
          <div class="filtro" id="ultimo">
            ...
            ?>
               <label>
              <input type="checkbox" name="filtromarca" id="checkbox-left" onchange="aplicarFiltro()" value="<?php echo $arraymarcas[0] ?>">
