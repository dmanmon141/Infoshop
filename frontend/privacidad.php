...
<body>
  ...
  <div class="contenedor">
    <div class="block">
      ...
      <p>En Infoshop, estamos comprometidos con la protección de tu privacidad. Esta Política de Privacidad describe
        cómo recopilamos, utilizamos, divulgamos y protegemos la información personal que obtenemos de los usuarios de
        nuestro sitio web y clientes. Al utilizar nuestros servicios, aceptas los términos y prácticas descritos en esta
        Política de Privacidad.</p>

      <h2>1. Recopilación de Información</h2>
      <h3>1.1 Información Personal</h3>

      <p>Podemos recopilar información personal identificable de distintas formas, incluyendo cuando nos la proporcionas
        voluntariamente al realizar una compra, crear una cuenta, suscribirte a nuestro boletín de noticias, participar
        en encuestas o completar formularios en nuestro sitio web. Esta información puede incluir tu nombre, dirección
        de correo electrónico, número de teléfono, dirección de envío y facturación, entre otros datos necesarios para
        brindarte nuestros servicios.</p>

      <h3>1.2 Información de Pago</h3>

      <p>Cuando realizas una compra en nuestro sitio web, podemos recopilar información de pago, como los detalles de tu
        tarjeta de crédito o débito, para procesar y completar la transacción. Esta información se maneja de forma
        segura utilizando tecnologías de encriptación y no se almacena en nuestros servidores.</p>

      <h3>2. Uso de la Información</h3>
      <p>Utilizamos la información recopilada para brindarte nuestros servicios, procesar tus pedidos, comunicarnos
        contigo sobre tu cuenta y proporcionarte información relevante sobre nuestros productos, promociones y
        actualizaciones. También podemos utilizar la información para mejorar nuestros servicios, personalizar tu
        experiencia de usuario y realizar análisis internos.</p>
      ...
      <p>No compartimos tu información personal con terceros, excepto en los siguientes casos:
        ...
        Proveedores de servicios: Podemos compartir tu información con proveedores de servicios externos que nos ayudan
        en la operación de nuestro negocio, como procesadores de pagos, empresas de envío y servicios de atención al
        cliente. Estos proveedores están obligados a utilizar la información de acuerdo con nuestras instrucciones y
        mantener su confidencialidad.

        Cumplimiento legal: Podemos divulgar tu información personal cuando sea requerido por la ley, una orden judicial
        o una autoridad gubernamental.</p>

      <h3>4. Seguridad de la Información</h3>
      <p>Tomamos medidas razonables para proteger la información personal que recopilamos y almacenamos, tanto durante
        la transmisión como una vez recibida. Utilizamos tecnologías de seguridad adecuadas para proteger contra el
        acceso no autorizado, el uso indebido, la alteración o la divulgación de la información.</p>

      <h3>5. Enlaces a Sitios Externos</h3>
      <p>Nuestro sitio web puede contener enlaces a sitios web de terceros. No nos responsabilizamos de las prácticas de
        privacidad o el contenido de dichos sitios. Te recomendamos que revises las políticas de privacidad de esos
        sitios antes de proporcionar cualquier información personal.</p>

      <h3>6. Cambios en la Política de Privacidad</h3>
      <p>Nos reservamos el derecho de actualizar o modificar esta Política de Privacidad en cualquier momento. Te
        notificaremos sobre cualquier cambio relevante publicando la versión actualizada en nuestro sitio web. Es tu
        responsabilidad revisar periódicamente esta Política de Privacidad para estar informado sobre cualquier cambio.
      </p>

      <h3>7. Contacto</h3>

      <p>Si tienes alguna pregunta, inquietud o solicitud relacionada con esta Política de Privacidad o el manejo de tu
        información personal, puedes comunicarte con nosotros a través de los siguientes medios:
      ...
      <ul class="lista-privacidad">
        ...
        <ul>
          ...
          Recuerda que el uso de nuestro sitio web y servicios está sujeto a los términos y condiciones establecidos en
          nuestros Términos de Servicio y esta Política de Privacidad.
