  ...
  <!-- Resto del contenido de la página -->
        ...
        <div class="dividir">
            ...
            <div class="bloque1">
                ...
                <a href="datospago"><div class="seccionconfiguracion">Datos de pago</div></a>
            ...
            <div class="bloque2" id="producto-contenedor">
                <div id="contenido">
                    ...
                    <div class="datosusuario">
                        ...
                        if($newsletter > 0){
                            ?>
                            <div class="checkbox"><input type="checkbox" id="suscripcion" name="suscripcion" checked onclick="checkDatos()"><p style="font-size: 11px;margin-left: 0px;">Quiero recibir correos sobre ofertas, facturas y pedidos</p></div>
                            <?php
                        }else{
                            ?>
                        <div class="checkbox"><input type="checkbox" id="suscripcion" name="suscripcion"  onclick="checkDatos()"><p style="font-size: 11px;margin-left: 0px;">Quiero recibir correos sobre ofertas, facturas y pedidos</p></div>
                        <?php
                        }
                        ?>
