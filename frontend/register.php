...
<div class="contenedor2">
    ...
    <div class="block formulario">
        ...
        <fieldset>
            ...
            <div class="password-container">
                <input type="password" id="repetir-contraseña-input" name ="repetir-contraseña" placeholder="Repetir Contraseña">
...
<footer>
  ...
  <div class="derechos">
    ...
    <p><a href="privacidad" class="politicalink">Política de Privacidad</a></p>
  </div>
</div>
</footer>
