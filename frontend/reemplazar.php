...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/estilo-reemplazar.css">
...
<div class="container">
  <div class="bloque">
        ...
        <div class="producto-detalles">
          ...
          ?>
          <div class="fechas">
            <p style="color: black">Pedido realizado el:</p>
            <p><?php echo $fecha ?></p>
          </div>
          <div class="estado">
          <p style="color: black">Estado del pedido</p>
          <?php
          ...
          <?php
            ...
            ?>
            <p style="color: white"><?php echo $pedidoarray['PEDEST']; ?></p>
          <?php
          }
          ?>
          </div>
        ...
        <form class="formulariodevolucion" action="backend/reemplazarcheck.php" method="POST">
          ...
          <div class="formulariodatos">
            <div class="razon">
                <p>¿Por qué quiere reemplazar este producto?</p>
            ...
            <p style="font-size: 14px;"><em>Tu producto será reenviado en un plazo de 2-3 días</em></P>
            <div class="boton"> 
